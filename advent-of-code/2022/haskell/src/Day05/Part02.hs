...
-- I'm being a bit lazy, there is probably a better way to not duplicate code here, but it's 00:30
-- only the transfer function is different, I'm pretty sure

import Data.Void (Void)
import Text.Megaparsec
import Text.Megaparsec.Char (digitChar, string, spaceChar)
...
transfer n (xs, ys) = (drop n xs, take n xs ++ ys)
